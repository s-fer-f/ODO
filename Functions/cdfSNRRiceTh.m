...
function CDF = cdfSNRRiceTh(PR, K, SNR_av)
% Theoretical power CDF (SNR) under Rice channels
% Eq. 20 - Wireless Channel Modeling Perspectives for Ultra-Reliable Communications
% https://ieeexplore.ieee.org/document/8660712

CDF = 1 - marcumq(sqrt(2*K), sqrt(2*(K + 1).*PR./SNR_av));
end